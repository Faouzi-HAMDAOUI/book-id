      ...
      <v-col md="6" sm="6" xs="4">
        ...
        <v-card class="mx-auto" max-width="auto" v-if="nameChat">
          <v-list v-for="myMessage in allMessages[0]" :key="myMessage.id">
            ...
            >
              <v-snackbar
                v-if="myMessage.idRecepteur == idChat"
                :timeout="-1"
                :value="true"
                absolute
                right
              ...
              <v-snackbar
                v-if="myMessage.idEmeteur == idChat"
                :timeout="-1"
                :value="true"
                absolute
                left
      ...
      <v-col md="3" sm="4" xs="2">
        <v-card class="text-center" v-if="nameChat">
          ...
          <v-btn
            ...
            color="primary"
            link
            :to="{ name: 'User', params: { id: this.idChat } }"
          >
            Voir le profil
          </v-btn>
        </v-card>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-subtitle
                  >A rendre le 10/04/2021</v-list-item-subtitle
                >
              </v-list-item-content>
            </v-list-item>
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-subtitle
                  >Prét du livre à valider</v-list-item-subtitle
                >
              </v-list-item-content>
            </v-list-item>
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-subtitle
                  >Retour le 03/04/2021</v-list-item-subtitle
                >
              </v-list-item-content>
            </v-list-item>
          </v-list>
